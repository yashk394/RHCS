...
public class frag3 extends Fragment {
    ...
    private int[] slider = new int[]{
            R.drawable.teslamachine, R.drawable.tesla4
    };
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        txt = view.findViewById(R.id.txte);
//        txt.setPaintFlags(txt.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            t.setJustificationMode(Layout.JUSTIFICATION_MODE_INTER_WORD);
        }
        CarouselView carouselview = view.findViewById(R.id.machinee);
        ...
        txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                browse.setData(Uri.parse("https://www.mayoclinic.org"));
